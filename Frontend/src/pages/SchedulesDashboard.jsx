...
import {
  CalendarClock, RefreshCw, Loader2, AlertCircle, Trash2, ListChecks, DownloadCloud, X,
} from 'lucide-react';
import {
  fetchAllSchedules,
...
export default function SchedulesDashboard() {
  ...
  const totalCount = suiteSchedules.length + harvestSchedules.length;
      ...
      {!isLoading && totalCount === 0 && (
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-12 text-center">
          ...
          <p className="text-slate-500 text-sm">
            ...
            <span className="font-medium text-slate-700">Test Suites</span>, or from the{' '}
            <span className="font-medium text-slate-700">Harvest</span> wizard.
          </p>
        </div>
      )}
